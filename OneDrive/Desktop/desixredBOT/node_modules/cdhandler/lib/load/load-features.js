...
var load = function (client, dir) { return __awaiter(void 0, void 0, void 0, function () {
    var exists, files, _i, files_1, file, isFolder, name_1, nam;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                (_a.sent()).default(client);
                name_1 = file.split(".")[0];
                console.log(cdcolours_1.default("[CDHandler]", { textColour: "magenta" }) + (" Loading feature " + name_1));
                return [3 /*break*/, 5];
            case 4:
                if (file.endsWith(".coffee") || file.endsWith(".js") && !file.endsWith(".d.ts")) {
                    require(path_1.join(process.cwd(), dir, file))(client);
                    nam = file.split(".")[0];
                    console.log(cdcolours_1.default("[CDHandler]", { textColour: "magenta" }) + (" Loading feature " + nam));
                }
                else
                    return [3 /*break*/, 5];
                _a.label = 5;
