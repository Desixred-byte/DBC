...
module.exports.validateOptions = (options, type) => {
	...
	else validOptions.deleteReaction = options.deleteReaction;
	...
	else validOptions.deleteAllOnEnd = options.deleteAllOnEnd;
    ...
    case 'messageAsyncQuestion':
		...
		else validOptions.deleteMessage = options.deleteMessage
